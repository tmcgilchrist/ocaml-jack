...
(* OASIS_START *)
(* DO NOT EDIT (digest: 7aa042b1e2d063217dde5c3fcfe69ac0) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = None;
          synopsis =
            "Jack is an alternative to QuickCheck generators / shrinking.";
          description = None;
          categories = [];
     ...
     oasis_version = "0.4.6";
     oasis_digest = Some "\027Z\253\205tE\\\163\232S\023\139\244\147\023\144";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
